...
public class CR_BoardInitTests {
	...
	public void FourDoorDirections() {
		...
		BoardCell cell = board.getRoomCellAt(board.calcIndex(0, 6));
	...
	public void testRoomInitials() {
		// CHANGED getInitial TO getRoomType, HAD DIFFERENT NAMES
		assertEquals('C', board.getRoomCellAt(0, 0).getRoomType());
		assertEquals('R', board.getRoomCellAt(4, 8).getRoomType());
		assertEquals('B', board.getRoomCellAt(9, 0).getRoomType());
		assertEquals('O', board.getRoomCellAt(21, 22).getRoomType());
		assertEquals('K', board.getRoomCellAt(21, 0).getRoomType());
	}
